...
$('.js-4').attr('src', (dpi>1) ? 'images/group-3-168.png' : 'images/group-3-84.png');}else{$('.js').attr('src', (dpi>1) ? 'images/shou-ye-1200-384.jpg' : 'images/shou-ye-1200-192.jpg');
...
$('.js-4').attr('src', (dpi>1) ? 'images/group-3-164.png' : 'images/group-3-82.png');}}};
